...
lucas =     User.create(coloc: dream_coloc, email: 'monica@gmail.com',  password: 'azerty',      name: 'Monica', avatar: 'monica.png', current_points: 180, total_points: 180)
nico =      User.create(coloc: dream_coloc, email: 'joey@gmail.com',  password: 'azerty',    name: 'Joey', avatar: 'joey.png', current_points: 180, total_points: 180)
louis =     User.create(coloc: dream_coloc, email: 'rachel@gmail.com',    password: 'azerty',      name: 'Rachel', avatar: 'rachel.png', current_points: 180, total_points: 180)
guillaume = User.create(coloc: dream_coloc, email: 'chandler@gmail.com', password: 'azerty',  name: 'Chandler', avatar: 'chandler.png', current_points: 180, total_points: 180)
...
FunCard.create(name: "Apéro",      description: "C'est l'apéro ! \n J'invite des potes", points: 150, image: 'apero_time.png')
FunCard.create(name: "No Wifi",         description: "Quelqu'un télécharge ? \n C'est pas le moment !", points: 100, image: 'stop_wifi.png')
FunCard.create(name: "À moi la télé !",     description: "Shotgun ! C'est moi qui choisi ce qu'on regarde", points: 90, image: 'tv.png')
FunCard.create(name: "La meilleure place",     description: "Désolé les gars,\n mais ce soir j'suis allongé", points: 70, image: 'couch_seat.png')


FunCard.create(name: "Virer un coloc'",     description: "La sentence est irrévocable.\n Tu sors !", points: 10000, image: 'adieu_coloc.png')
