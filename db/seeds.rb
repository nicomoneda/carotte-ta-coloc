...
Task.create(coloc: dream_coloc,  name: "Passer la serpière" , description: "À l'eau chaude stp", points: 35, carotte_card_name: "joker", carotte_card_points: 45, image: 'mop.png', image_done: 'mop_done.png')
Task.create(coloc: dream_coloc,  name: "Laver la SDB" , description: "Oublie pas d'enlever les poils", points: 30, carotte_card_name: "joker", carotte_card_points: 40, image: 'bath.png', image_done: 'bath_done.png')
...
FunCard.create(name: "No Wifi",         description: "Flemme que ça beug", points: 100, image: 'stop_wifi.png')
